"""Database helpers and schema setup for the Flask backend."""
...
def ensure_column(db: sqlite3.Connection, table_name: str, column_name: str, column_type: str) -> None:
    """Add a column to an existing table when the database is older than the code.

    This helps with lightweight schema upgrades during development.
    """
...
def init_db(app) -> None:
    """Create base tables and apply simple schema upgrades."""
    ...
    with app.app_context():
        ...
        # Backfill columns for older local database files.
