...
async function loadEventSelector() {
    ...
    try {
        ...
        if (!events.length) {
            document.getElementById("planner-error").classList.remove("hidden");
            document.getElementById("planner-error").innerHTML = `
        ...
        dropdown.addEventListener("change", (e) => {
            ...
            window.location.href = `planner.html?event_id=${newId}`;
        });
